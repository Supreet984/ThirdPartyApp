...
signupbutton.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        Intent intent = new Intent( LandingScreen.this, SignUp.class);
        startActivity(intent);
    }
});
        Button otpButton = findViewById(R.id.button5);

        otpButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( LandingScreen.this, Phoneverification.class);
                startActivity(intent);
            }
        });
...
// google Signin
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            Log.w("con", "signInResult:failed code=" + e.getStatusCode());
            //updateUI(null);
        }
    }
